...
<title>Mostra dati di un medico</title>
...
<body>
	...
	<div class="container">
		<a href="../../../index.jsp">Clinica</a> | <a href="../menu.jsp">Menu
			amministrativo</a> | <strong>Mostra dati medico</strong>
						...
						<div class="form-group">
							<ul>
								...
								<ul>
									<div>
										<p>
											<b><u>Nome:</u></b> ${(medico.nome).toUpperCase()}
										</p>
									</div>
									<div>
										<p>
											<b><u>Cognome:</u></b> ${(medico.cognome).toUpperCase()}
										</p>
									</div>
									<div>
										<p>
											<u>Specializzazione:</u> ${medico.specializzazione}
										</p>
									</div>
								</ul>
							</ul>
							<a class="btn btn-primary" id="myButton"
								...
								href="<c:url value="../menu.jsp"/>">Menu amministrativo</a> 
							<a class="btn btn-success" id="myButton"
								data-loading-text="Caricando..." autocomplete="off"
								href="<c:url value="registrazioneMedico.jsp"/>" role="button">Inserire
								medico</a>
						</div>
					</form>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h4>
						Il medico <b>${(medico.cognome).toUpperCase()}</b><br> con
						nombre <b>${(medico.nome).toUpperCase()}</b> <br>è stato <u>aggiunto</u>
