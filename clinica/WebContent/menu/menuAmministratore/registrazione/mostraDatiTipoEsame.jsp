...
<title>Mostra dati di una tipologia di esame</title>
...
<body>
	...
	<div class="container">
		<a href="../../../index.jsp">Clinica</a> | <a href="../menu.jsp">Menu
			amministrativo</a> | <strong>Mostra dati tipologia</strong>
		<div class="jumbotron container">
			<div class="row">
				...
				<div class="col-lg-8">
					<!-- Form inserimento -->
					<form>
						<h3>Inserimento di una nuova tipologia di esame</h3>
						<div class="form-group">
							<ul>
								<div>
									<p>
										Tipo esame con identificatore: <b>${tipoEsame.codice}</b>
									</p>
								</div>
								...
								<ul>
									<div>
										<p>
											<b><u>Nome:</u></b> ${(tipoEsame.nome)}
										</p>
									</div>
									<div>
										<p>
											<b><u>Descrizione:</u></b> ${(tipoEsame.descrizione)}
										</p>
									</div>
									<div>
										<p>
											<b><u>Costo:</u></b> ${tipoEsame.costo} euro
										</p>
									</div>
									<div>
										<p>
											<b><u>Prereguisiti:</u></b>
										<ul>
											<div>Nome: ${tipoEsame.nomePrerequisiti}</div>
											<div>Descrizione: ${tipoEsame.descrizionePrerequisiti}</div>
										</ul>
										</p>
									</div>
								</ul>
							...
							<a class="btn btn-primary" id="myButton"
								...
								data-loading-text="Caricando..." autocomplete="off"
								href="<c:url value="registrazioneTipoEsame.jsp"/>" role="button">Inserire
								esame</a>
						</div>
					</form>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h4>
						Il tipo di esame con codice <b>${tipoEsame.codice}</b><br>
						cui nome è <b>${(tipoEsame.nome).toUpperCase()}</b> <br>è
						stato <u>aggiunto</u> nella <u>base di dati</u>
					</h4>
				</div>
